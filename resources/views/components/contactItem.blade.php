<div class="">
    <div id="contact" class="w-full mt-2 mb-12 rounded-md max-w-[400px] md:max-w-[80%] mx-auto">
      <form class="w-full max-w-[400px] mx-auto md:max-w-[50%] lg:max-w-[40%] md:mx-0 py-2 rounded-lg">
        ...
        <div class="flex flex-col gap-2 mb-6">
          <button type="submit" class="bg-blue-600 py-2 px-5 text-sm text-white rounded font-light w-[100px] hover:bg-blue-700 transition duration-150 ease-in-out active:bg-blue-800">
            Send
          </button>
        </div>
      </form>
